          ...
          <div className="hero-content-grid">
            ...
            <div className="hero-form-wrapper">
              <div className="form-card-exact">
                <h3>Request a Security Assessment</h3>
                <form className="service-form-exact" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="form-group-exact">
                    ...
                    <textarea placeholder="Tell us about your security concerns (e.g., threat detection, compliance, regular maintenance)"></textarea>
                  </div>
